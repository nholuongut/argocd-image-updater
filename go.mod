module github.com/nholuongut/argocd-image-updater
...
require (
	github.com/mainminds/semver/v3 v3.2.1
...
replace github.com/nholuongut/argocd-image-updater/registry-scanner => ../registry-scanner
