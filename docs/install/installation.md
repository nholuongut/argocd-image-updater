...
!!!note
    ...
    `https://github.com/nholuongut/argocd-image-updater/manifests/base`. 
    You can view the manifests [here](https://github.com/nholuongut/argocd-image-updater/tree/stable/manifests/base)

### Apply the installation manifests

```shell
kubectl apply -n argocd -f https://raw.githubusercontent.com/nholuongut/argocd-image-updater/stable/manifests/install.yaml
```
...
kubectl apply -n argocd-image-updater -f https://raw.githubusercontent.com/nholuongut/argocd-image-updater/stable/manifests/install.yaml
```
...
[local user](https://https://github.com/nholuongut/argo-cd/operator-manual/user-management/)
...
[here](https://github.com/nholuongut/argocd-image-updater/tree/main/config)
